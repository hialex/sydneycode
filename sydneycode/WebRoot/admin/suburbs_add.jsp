    	...
    	<div id="content">
    		...
    		<div class="row">
	    		...
	    		<div class="col-sm-10 main">
	    		    <div class="well well-sm"><strong>添加Suburbs</strong></div>
	    		</div>
	    		<div class="col-sm-1"></div>
    		</div>
    		<div class="row">
	    		    ...
	    		    <form class="form-horizontal" role="form">
					  ...
					  <div class="form-group">
					    <div class="col-sm-offset-2 col-sm-2">
					      <button type="submit" id="btn_add_suburb" class="btn btn-default">添加</button>
					    </div>
					  </div>
					</form>
	    		</div>
  		...
  		$(function(){
	  		...
	  		$('#btn_add_suburb').click(function(){
	  			...
	  			if(suburb_name==''){
	  				...
	  				submitSuburb(suburb_name,parent_id,hot_suburb);
	  			}
	  			return false;
	  		});
	  		
	  	});
	  	function submitSuburb(suburb_name,parent_id,hot_suburb){
	  		var t = new Date().getTime();
	  		$.ajax({
                type: "POST",
                dataType: "json",
                //cache:true,
                url: "Suburb!add.action",
                data: { "suburb.name": suburb_name, "suburb.parent_id": parent_id,"suburb.is_hot": hot_suburb,"t":t},                              
                success: function(json) {
                	if(json.status==1){
                		//保存成功
                		alert(json.message);
