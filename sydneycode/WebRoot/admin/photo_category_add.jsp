    	...
    	<div id="content">
    		...
    		<div class="row">
	    		...
	    		<div class="col-sm-10 main">
	    		    <div class="well well-sm"><strong>添加图片分类</strong></div>
	    		</div>
	    		<div class="col-sm-1"></div>
    		</div>
    		<div class="row">
	    		...
	    		<div class="col-sm-10">
	    		    <form class="form-horizontal" role="form">
	    		      <div class="form-group">
					    <label for="catalog_top" class="col-sm-2 control-label">归属类别</label>
					    <div class="col-sm-3">
					  ...
					  <div class="form-group">
					    <div class="col-sm-offset-2 col-sm-2">
					      <button type="submit" id="btn_add_category" class="btn btn-primary">添加</button>
					    </div>
					  </div>
					</form>
	    		</div>
  		...
  		$(function(){
	  		...
	  		$('#btn_add_category').click(function(){
	  			...
	  			if(category_name==''){
	  				...
	  				submitPhotoCategory(category_name,catalog_id,catalog_name,order_id);
	  			}
	  			return false;
	  		});
	  		
	  	});
	  	function submitPhotoCategory(category_name,catalog_id,catalog_name,order_id){
	  		var t = new Date().getTime();
	  		$.ajax({
                type: "POST",
                dataType: "json",
                //cache:true,
                url: "PhotoCategory!add.action",
                data: { "category.name": category_name, "category.catalog_id": catalog_id,"category.catalog_name": catalog_name,"category.order_id": order_id,"t":t},                              
                success: function(json) {
                	if(json.status==1){
                		//保存成功
                		alert(json.message);
