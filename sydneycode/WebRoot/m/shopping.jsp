	...
	<script>
		...
		$(document).on("pagebeforecreate", function (){
			...
			$.ajax({
				...
				dataType:"json",
				data:{ "parent_id": 1,"from":"mobile","rootId":3},
				success:function(json){
  ...
  <body>
    <div data-role="page">
		<div data-role="header" id="header">
			<div id="link_r"><a href="search.jsp?rootId=3" data-ajax="false"><i class="grey fa fa-search "></i></a></div>
		...
		<div data-role="content">
			<form id="filterForm">
				...
				<div class="ui-block-b block-content">
					<a href="result.jsp" id="btn_search" data-ajax="false" data-transition="slidedown" class="ui-btn ui-corner-all">马上搜索</a>
				</div>
			</form>
		</div>
